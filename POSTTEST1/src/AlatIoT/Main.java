...
class komponeniot {
    ...
    public komponeniot(String nama, String tipe) {
        this.nama = nama;
        this.tipe = tipe;
    }
...
public class Main {
    private static ArrayList<komponeniot> components = new ArrayList<>();
    ...
    private static void tambahKomponen() {
        ...
        komponeniot component = new komponeniot(name, type);
    ...
    private static void tampilkanKomponen() {
        if (components.isEmpty()) {
            ...
            for (komponeniot component : components) {
    ...
    private static void updateKomponen() {
        ...
        if (!components.isEmpty()) {
            ...
            if (index >= 0 && index < components.size()) {
                ...
                komponeniot updatedComponent = new komponeniot(newName, newType);
